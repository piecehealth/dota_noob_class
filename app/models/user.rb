...
class User < ApplicationRecord
  ...
  scope :students_with_dota_id, -> { where.not(dota2_player_id: nil) }
  scope :active_students, -> { where.not(dota2_player_id: nil) }
  scope :student, -> { where.not(dota2_player_id: nil) }
